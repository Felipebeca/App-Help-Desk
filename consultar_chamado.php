...
<?php 
// guardar chamados dentro de um array
$chamados = [];
...
while(!feof($arquivo)){ // feof() testa pelo o fim de um arquivo 
  
    $registro = fgets($arquivo); // fgets(); recupera o valor contido nas linhas do arquivo
    $chamados[] =  $registro;
}
            ...
            <div class="card-body">
              ...
              <?php $chamados_dados = explode('#', $chamado); 
                  ...
                  if($_SESSION['perfil_id'] == 2){
                    // Só vamos exibir o chamado se ele foi criado por adm.
